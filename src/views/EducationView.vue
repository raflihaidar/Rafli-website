    ...
    <div class="w-[80%] mx-auto my-10">
        ...
        <div class="lg:w-[35%] w-full bg-sky-950 hover:bg-blue-950 transition-colors ease-in-out rounded-b-xl">
          ...
          <div class="w-full text-white px-2 py-3">
            <a href="https://ittelkom-sby.ac.id/" target="_blank"
              class="text-xl font-semibold hover:underline cursor-pointer transition">Telkom University Campus
              Surabaya</a>
      ...
      <section class="py-10">
        ...
        <transition to="projectView">
          <ModalComponent name="certificate" :status="modalStatus" :data="modalContent" @close-modal="closeModal" />
        </transition>
      </section>
    </div>
  </main>
